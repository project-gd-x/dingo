...
var typeTests = map[Type]struct {
	...
	"github.com/project-gd-x/dingo/dingotest/go-sub-pkg.Person": {
		String:                 "github.com/project-gd-x/dingo/dingotest/go-sub-pkg.Person",
		IsPointer:              false,
		PackageName:            "github.com/project-gd-x/dingo/dingotest/go-sub-pkg",
		...
		UnversionedPackageName: "github.com/project-gd-x/dingo/dingotest/go-sub-pkg",
		IsFunction:             false,
	},
	"*github.com/project-gd-x/dingo/dingotest/go-sub-pkg.Person": {
		String:                 "*github.com/project-gd-x/dingo/dingotest/go-sub-pkg.Person",
